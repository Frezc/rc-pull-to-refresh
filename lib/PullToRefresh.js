...
var PullToRefresh = function (_Component) {
  ...
  function PullToRefresh() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PullToRefresh.__proto__ || Object.getPrototypeOf(PullToRefresh)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      pullOffset: 0,
      disableTrans: false
    }, _this.lastY = 0, _this.pulling = false, _this.handleTouchStart = function (e) {
      ...
      if (_this.state.pullOffset > 0) e.preventDefault();
      if (_this.props.loading) return;
      var contentEl = _this.refs.content;
      var touch = e.changedTouches[0];
      if (contentEl.scrollTop >= 1) _this.pulling = false;
      if (_this.pulling) {
        var offset = (touch.pageY - _this.lastY) * (1 / _this.props.resistance);
        _this.setState({
          pullOffset: Math.max(_this.state.pullOffset + offset, 0)
        });
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          style: _extends({}, style, this.getTranslate(displayOffset)),
